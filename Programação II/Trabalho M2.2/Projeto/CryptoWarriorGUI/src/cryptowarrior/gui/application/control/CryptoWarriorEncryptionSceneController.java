...
public class CryptoWarriorEncryptionSceneController implements Initializable
{
    @FXML
    ...
    // Run <Cryptograph>
    @FXML
    private Button bRunCryptography;
    ...
    private void execute()
    {
        try {
            ...
            encryptor.encrypt( FileSystemPartFactory.create(this.tDirectory.getText()) );
            
            VaultAlert.show("Arquivo Encriptado!", "O arquivo/diretório foi encriptado com sucesso!", Alert.AlertType.INFORMATION);
        } catch (IOException ex) {
            VaultAlert.show("Erro ao criptografar", "Erro inesperado ao criptografar. Arquivos existem?", Alert.AlertType.ERROR);
        } catch (Exception ex) {
    ...
    private void setupEvents()
    {
        ...
        this.bFind.setOnAction(e -> {
            ...
            fc.setTitle("Definir Arquivo ou Diretório para Criptografar");
        ...
        this.bRunCryptography.setOnAction(e -> this.execute());
    }
